...
describe( 'checkFormValidity', () => {
    ...
    test( 'checkFormValidity basic usage', () => {
        ...
        const field_3_2 = formEl.querySelector('[name="radio-list-2"]');
        const field_3_2more = formEl.querySelector('[name="radio-list-2-more"]');
        ...
        const returnObj = {
            fields: [
                ...
                { fieldEl: field_3_2, result: true },
                { fieldEl: field_3_2more, result: false },

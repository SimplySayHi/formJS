        ...
        function ajaxCall(formDataObj) {
            ...
            var XHR = new XMLHttpRequest(), parseResponse = function parseResponse(xhr) {
                ...
                if (xhr.status === 200) {
                    ...
                    _helper.executeCallback.call(self, formOptions.onSubmitSuccess, responseData);
                } else {
                    errorFn(e);
                }
            }, errorFn = function errorFn(e) {
                var xhr = e.target;
                _helper.executeCallback.call(self, formOptions.onSubmitError, xhr);
        ...
        function submit(event) {
            ...
            formValidationPromise.then(function(formValidation) {
                ...
                if (isAjaxForm) {
                    ...
                    _ajaxCallXhr.ajaxCall.call(self, formData);
                }
            });
        }
    },

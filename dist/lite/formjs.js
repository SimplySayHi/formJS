...
!function(global, factory) {
    ...
    const removeClass = function(element) {
    ...
    }, isDOMNode$1 = node => Element.prototype.isPrototypeOf(node), mergeObjects = function() {
        ...
        result: !1,
        $field: null
    }, obj), runFunctionsSequence = function() {
    ...
    }, toCamelCase = string => string.replace(/-([a-z])/gi, ((all, letter) => letter.toUpperCase())), customEvents_field = {
